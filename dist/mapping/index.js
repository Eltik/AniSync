...
const nineanime_1 = __importDefault(require("./impl/anime/nineanime"));
...
const ANIME_PROVIDERS = [new nineanime_1.default(), new gogoanime_1.default(), new zoro_1.default(), new animepahe_1.default()];
...
exports.Formats = ["TV" /* Format.TV */, "TV_SHORT" /* Format.TV_SHORT */, "MOVIE" /* Format.MOVIE */, "SPECIAL" /* Format.SPECIAL */, "OVA" /* Format.OVA */, "ONA" /* Format.ONA */, "MUSIC" /* Format.MUSIC */, "MANGA" /* Format.MANGA */, "NOVEL" /* Format.NOVEL */, "ONE_SHOT" /* Format.ONE_SHOT */, "UNKNOWN" /* Format.UNKNOWN */];
